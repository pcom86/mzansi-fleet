...
try
{
    ...
    Console.WriteLine("  - Added column: NextOfKin");
    Console.WriteLine("  - Added column: NextOfKinContact");
    Console.WriteLine("  - Added column: Address");
    Console.WriteLine("  - Added column: Destination");
}
catch (Exception ex)
{
